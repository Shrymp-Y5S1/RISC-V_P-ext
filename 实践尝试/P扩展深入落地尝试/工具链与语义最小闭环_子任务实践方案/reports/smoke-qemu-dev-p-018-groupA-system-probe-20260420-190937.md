...
- Time (UTC): 2026-04-20 11:09:37 UTC
...
```bash
cat /tmp/tmp.Ouv5yV1mPo | /home/shrymp/qemu-devp018-work/qemu-src/build/qemu-system-riscv64 -machine none -nographic -display none -S -monitor none -serial none -qmp stdio
```
...
{"timestamp": {"seconds": 1776683377, "microseconds": 613376}, "event": "SHUTDOWN", "data": {"guest": false, "reason": "host-qmp-quit"}}
{"return": {}}
```
...
```text
(exit=124)
qemu-system-riscv64: terminating on signal 15 from pid 466 (timeout)
```
